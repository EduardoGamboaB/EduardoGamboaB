...
export function ProfileHeader({ avatar, name, role, badge = 'MES' }) {
  return (
    <div style={{
      padding: '14px 14px',
      ...
      <div style={{
        ...
        ...fontDisplay, fontWeight: 900, fontSize: 22,
        flexShrink: 0,
      ...
      {badge && (
        <div style={{ padding: '5px 9px', background: brand.red, color: 'white', borderRadius: 6, ...fontDisplay, fontWeight: 800, fontSize: 10, letterSpacing: '0.1em' }}>{badge}</div>
      )}
    </div>
  )
}
