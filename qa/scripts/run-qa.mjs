...
const ROUTES = [
  ...
  { path: '/pedidos/VFGC-872', name: 'pedido-detalle', label: 'Detalle pedido' },
  ...
  { path: '/control-mp', name: 'control-mp', label: 'Control MP' },
  { path: '/pedidos-almacen', name: 'pedidos-almacen', label: 'Pedidos Almacén' },
  { path: '/montacargas', name: 'montacargas', label: 'Montacargas' },
