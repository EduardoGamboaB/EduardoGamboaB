/**
 * Datos demo del MES Mallatex v6.
 * Pedidos, operarios, rollos, recepciones, egresos, mermas, productividad —
 * todos extraídos del Excel PLANEACION_DE_PEDIDOS y archivos formales reales.
 */
...
export interface Roll {
  ...
  ubicacion: string
  pedido: string | null
  estado: 'almacen' | 'en-linea' | 'reservado' | 'faltante'
  empezado: boolean
}
...
export interface Aviso {
  ...
  desc: string
  tiempo: string
  estado: 'urgente' | 'revisar' | 'resuelto'
}
...
export interface Merma {
  ...
  material: string
  metros: number
  categoria: 'sobrante' | 'defecto' | 'desperdicio'
  defecto: string
  pedido: string
}
...
export const initialRecepciones: Recepcion[] = [
...
export const initialMermas: Merma[] = [
...
export const initialProductosTerminados: ProductoTerminado[] = [
...
export const initialProductividad: Productividad[] = [
