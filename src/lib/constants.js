// Mallatex MES — catálogos y constantes alineadas a CLAUDE.md §5.
import { brand } from './brand'

// Roles formales según procesos MT-PC-001/002/003 + Manual de Organización
export const ROLES = {
...
export const FORMAS_ENTREGA = ['ALMACEN', 'MALLATEX', 'MALLATEX envía campo', 'PAQUETERIA', 'TRES GUERRAS']

// Catálogo de clientes reales (extraídos de PLANEACION_DE_PEDIDOS.xlsx)
...
// Líneas reales con códigos del Excel: LC1-LC4 (Costura), LK (Corte/Kornit), LP (Perforadora), LE (Embobinado)
...
// Mapa emoji por máquina/proceso/línea (códigos reales del Excel: LC1-LC4, LK, LP, LE)
export const EMOJI_LINEA = {
  'LC1': '🧵', 'LC2': '🧵', 'LC3': '🧵', 'LC4': '🧵',
  'LK': '✂️', 'LP': '🔨', 'LE': '📦', 'LC': '🧵',
  // Alias amigables
...
export const EMOJI_PROCESO = { corte: '✂️', perforacion: '🔨', costura: '🧵', embobinado: '📦' }

export const EMOJI_PROBLEMA = {
  falla: '🔧', 'sin-material': '📦', 'sin-hilo': '🧵', 'sin-luz': '💡',
  montacargas: '🚛', comida: '🍽️', bano: '🚻', otro: '❓',
}

// Mapa de avatares de cada rol (para el profile header)
